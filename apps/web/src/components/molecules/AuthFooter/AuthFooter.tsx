...
export function AuthFooter({ question, linkText, to, icon }: AuthFooterProps) {
  return (
    <div className="flex flex-wrap justify-center items-center gap-2 max-w-[400px]">
      <p className="text-[18px] text-foreground whitespace-nowrap">{question}</p>
      <TextLink to={to} tone="primary" className="text-[18px] inline-flex items-center gap-3 whitespace-nowrap">
        {linkText}
